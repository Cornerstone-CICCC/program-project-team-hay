export const DummyChatList = [
  ...
  { room_id: 'b10', type: 'archive', image: require('../assets/images/dummy02.png'), name: 'Hiking on the Grouse Mountain on New Year Day', last_message: 'What do you want to eat? I wanted to eat fries but they did not have them. So I decided to eat ice cream.', last_message_at: '18:19', unread_count: 12, num_member: 7 },
  { room_id: 'b11', type: 'archive', image: require('../assets/images/dummy02.png'), name: 'Snowboaring at Mt.Seymour', last_message: 'What do you want to eat?', last_message_at: '8:19', unread_count: 3, num_member: 4 },
