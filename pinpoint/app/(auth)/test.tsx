...
export default function TestFile() {
  ...
  const handleUpdateEventById = async () => {
    try {
      await updateEventById("40", {
        name: "event_test1_update",
        date: new Date("2026-04-05T16:00:00Z"),
        place_name: "Surrey chicken",
        address: "Surrey St",
        latitude: 234324323423423,
        longitude: 234255675675675,
        members: [
          { userId: "58caffce-5c2b-4499-8df9-25cd09d67ee6" },
          { userId: "21a62bd4-c115-4d33-a6cf-0dc11de6b05a" },
        ],
      });
    } catch (err) {
